...
input_files['mc'][2021]='/store/mc/Run3Winter21DRMiniAOD/SUSYGluGluToBBHToBB_NarrowWidth_M-600_TuneCP5_14TeV-pythia8/MINIAODSIM/FlatPU30to80FEVT_112X_mcRun3_2021_realistic_v16-v2/270000/00dcad37-67cf-4838-a4ab-5989f25a2749.root'

secondary_files['mc'][2021]='/store/mc/Run3Winter21DRMiniAOD/SUSYGluGluToBBHToBB_NarrowWidth_M-600_TuneCP5_14TeV-pythia8/GEN-SIM-DIGI-RAW/FlatPU30to80FEVT_112X_mcRun3_2021_realistic_v16-v2/270000/010db405-4620-48d4-8ddc-9bf6642c817d.root'
...
if not options.secondaryFiles:
   options.setDefault('secondaryFiles',secondary_files[options.type][options.year])
...
print("secondaryFiles    : ", options.secondaryFiles)
...
if options.year == 2017:
   ...
   process = cms.Process('HLTRun3',Run3)
...
process.load('Analysis.Ntuplizer.hltRun3Winter21MC_122X_scratch_mssmhbb_v10_cff')
...
process.MssmHbb     = cms.EDAnalyzer('Ntuplizer',
   ...
   PFJets          = cms.VInputTag( cms.InputTag('hltAK4PFJetsCorrected','','HLT'), ),
   JetsTags        = cms.VInputTag( cms.InputTag('hltDeepCombinedSecondaryVertexBJetTagsCalo','probb','HLT'),cms.InputTag('hltDeepCombinedSecondaryVertexBJetTagsCalo','probc','HLT'),),
...
#stage2L1Trigger.toModify(process.MssmHbb, stageL1Trigger = 2)
#########
...
secFiles.extend(options.secondaryFiles)
process.source = cms.Source ('PoolSource',fileNames = readFiles, secondaryFileNames = secFiles)

## Outputs
process.outputFull = cms.OutputModule( "PoolOutputModule",
...
process.FullOutput = cms.EndPath( process.outputFull )


process.schedule.extend([process.p])
#process.schedule.extend([process.p,process.FullOutput])
#process.schedule.extend(process.FullOutput)
