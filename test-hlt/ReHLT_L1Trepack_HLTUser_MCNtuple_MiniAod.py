...
#    fileNames = cms.untracked.vstring('/store/mc/PhaseIFall16DR/SUSYGluGluToBBHToBB_NarrowWidth_M-120_TuneCUETP8M1_13TeV-pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/00000/02C6F273-9115-E711-AF44-FA163E441C41.root'),
    fileNames = cms.untracked.vstring('/store/mc/PhaseIFall16MiniAOD/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/MINIAODSIM/FlatPU28to62HcalNZSRAW_PhaseIFall16_90X_upgrade2017_realistic_v6_C1-v2/130000/00DD46AE-EF13-E711-A0E8-001C23BED6A2.root'),
    secondaryFileNames = cms.untracked.vstring(
      '/store/mc/PhaseIFall16DR/TT_TuneCUETP8M2T4_13TeV-powheg-pythia8/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v2/130002/364565EB-3812-E711-82A4-0026B937D37D.root',
    )
)
...
process.MssmHbbTrigger.PrimaryVertices   = cms.VInputTag(cms.InputTag('hltFastPrimaryVertex'),cms.InputTag('hltFastPVPixelVertices'),cms.InputTag("offlineSlimmedPrimaryVertices"))
...
process.MssmHbbTrigger.PFJets            = cms.VInputTag(cms.InputTag('hltAK4PFJetsCorrected'),cms.InputTag('hltAK4PFJetsLooseIDCorrected'),cms.InputTag('hltAK4PFJetsTightIDCorrected'))
# miniaod (vertex is above)
process.MssmHbbTrigger.PatJets           = cms.VInputTag( cms.InputTag("slimmedJets"), cms.InputTag("slimmedJetsPuppi") )
process.MssmHbbTrigger.PatMuons          = cms.VInputTag( cms.InputTag("slimmedMuons") ) 
process.MssmHbbTrigger.BTagAlgorithms      = cms.vstring   ( "pfCombinedInclusiveSecondaryVertexV2BJetTags","pfJetProbabilityBJetTags","pfCombinedMVAV2BJetTags" )
process.MssmHbbTrigger.BTagAlgorithmsAlias = cms.vstring   ( "btag_csvivf", "btag_jetprob","btag_csvmva" )
...
if isMC:
   # MC specific
   # miniaod
   process.MssmHbbTrigger.GenJets         = cms.VInputTag(cms.InputTag("slimmedGenJets"))
   process.MssmHbbTrigger.GenParticles    = cms.VInputTag(cms.InputTag("prunedGenParticles"))
   #
